...
cp -r web3/rbh-chain-minting ~/.hermes/skills/web3/rbh-chain-minting/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/rbh-chain-minting-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/rbh-chain-minting-skill.git ~/.hermes/skills/web3/rbh-chain-minting/
```
...
```text
skill_view(name="web3/rbh-chain-minting")
```
...
```text
Use the rbh chain minting skill to <describe your specific task here>
```
...
```text
Gunakan skill rbh chain minting untuk <deskripsikan tugas spesifik Anda di sini>
```
